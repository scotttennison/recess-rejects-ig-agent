...
const GITHUB_REPOSITORY = process.env.GITHUB_REPOSITORY; // e.g. "scott/recess-rejects-ig-agent"
...
async function saveImageAndGetUrl(imageBuffer) {
  ...
  // Commit and push so the file is publicly reachable via raw.githubusercontent.com
